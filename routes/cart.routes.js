...
router.post('/:userId/items', authMiddleware.requireAuth, async (req, res) => {
  const userId = Number(req.params.userId);
...
router.put('/:userId/items/:productId', authMiddleware.requireAuth, async (req, res) => {
  const userId = Number(req.params.userId);
...
router.delete('/:userId/items/:productId', authMiddleware.requireAuth, async (req, res) => {
  const userId = Number(req.params.userId);
  const productId = Number(req.params.productId);
...
router.delete('/:userId', authMiddleware.requireAuth, async (req, res) => {
  const userId = Number(req.params.userId);
